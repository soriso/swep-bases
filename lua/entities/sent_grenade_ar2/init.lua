...
local    sk_plr_dmg_smg1_grenade	= server_settings.Int( "sk_plr_dmg_smg1_grenade", 100 );
local    sk_npc_dmg_smg1_grenade	= server_settings.Int( "sk_npc_dmg_smg1_grenade", 50 );
local    sk_max_smg1_grenade		= server_settings.Int( "sk_max_smg1_grenade", 3 );

local	  sk_smg1_grenade_radius		= server_settings.Int( "sk_smg1_grenade_radius","0");
